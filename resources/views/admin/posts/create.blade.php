<x-layout>
    ...
    <h1 class="ml-5 mb-4 text-lg font-bold"> Publish a new post </h1>
    <form action="/admin/post" class="border border-gray-200 rounded-xl p-6 " method="POST" enctype="multipart/form-data">
        @csrf
       <label class="font-bold uppercase block mb-2 text-xs text-gray-700">
        ...
        <div class="flex justify-end">
            <button type="submit" class="uppercase px-10 py-2 text-white mt-10 text-xs rounded-2xl bg-blue-500 hover:bg-blue-600">Publish</button>
        </div>
    </form>
    </section>
</x-layout>
